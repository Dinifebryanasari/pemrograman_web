...
class AnakPolicy
{
    ...
    {
        return $user->can('delete_any_anak');
    }
     ...
     */
    public function replicate(User $user, Anak $anak): bool
    {
